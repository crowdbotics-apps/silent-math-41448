"""
Django settings for silent_math_41448 project.
...
ROOT_URLCONF = 'silent_math_41448.urls'
...
WSGI_APPLICATION = 'silent_math_41448.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_math_41448 API",
    "DESCRIPTION": "API documentation for silent_math_41448 App",
    "VERSION": "v1",
}
